...
async function deleteTranslation(TranslationId, CareerId, element) {
    ...
    try {
        const DeleteUrl = `${baseUrl}EsAdmin/CareerTranslates/Delete?translationId=${TranslationId}&careerId=${CareerId}`;
        // Send DELETE request
