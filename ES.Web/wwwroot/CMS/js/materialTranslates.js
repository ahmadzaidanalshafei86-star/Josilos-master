...
async function deleteTranslation(TranslationId, MaterialId, element) {
    ...
    try {
        const DeleteUrl = `${baseUrl}EsAdmin/MaterialsTranslates/Delete?translationId=${TranslationId}&materialId=${MaterialId}`;
        // Send DELETE request
