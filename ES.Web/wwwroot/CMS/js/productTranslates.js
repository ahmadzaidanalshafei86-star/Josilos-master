...
async function deleteTranslation(TranslationId, ProductId, LanguageId, element) {
    ...
    try {
        const DeleteUrl = `${baseUrl}EsAdmin/ProductTranslates/Delete?translationId=${TranslationId}&productId=${ProductId}&languageId=${LanguageId}`;
        // Send DELETE request
